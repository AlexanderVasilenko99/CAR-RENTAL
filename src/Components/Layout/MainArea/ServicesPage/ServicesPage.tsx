            ...
            <div className="image-container">
                ...
                <div>
                    <SingleService serviceHeader="Monthly Rental" serviceImageName="calendar.png"
                        serviceParagraph="Looking to rent for a while? We got you covered!" destinationUrl="#" />
                </div>
                <div>
                    <SingleService serviceHeader="Chauffeur Services" serviceImageName="chauffeur.png"
                        serviceParagraph="We offer a variety of chauffer services at any time all year around." destinationUrl="#" />
                </div>
                <div>
                ...
                <div>
                    <SingleService serviceHeader="One Day Car Rental" serviceImageName="oneday.png"
                        serviceParagraph="Learn about our affordable one day rental program." destinationUrl="#" />
                </div>
                <div>
                    <SingleService serviceHeader="One Way Car Rental" serviceImageName="destination.png"
                        serviceParagraph="Learn about our affordable one way rental program." destinationUrl="#" />
                </div>
