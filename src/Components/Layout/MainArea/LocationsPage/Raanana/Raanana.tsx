        ...
        <div className="Raanana">
            ...
            <div className="grid-container">
                ...
                <div className="content">
                    ...
                    <p>The Ra'anana branch is located in Ra'ananas city center. Placed in a strategic location between Herzelias
                        and Ra'ananas infamous High-Tec industrial zones. The location is merely a 10 minute drive from both
                        Ra'ananas train stations, 10 minutes from Ra'ananas industrial zone, 10 kilometers from Herzelia And 30
                        kilometers from Tel Aviv city center.</p>
                    <h3>How To Reach Our Office in Ra'anana</h3>
                    <p>Our office is located at {params.address} You can find us on floor 1. There is plenty of parking on the
                        street and in the area.</p>

                    <h3>Map</h3>
                    <p></p>

                    <h3>Available Vehicles</h3>
                    <p>At Ra'anana you can choose the car that best suits your needs, you will have all our vehicles in the fleet
